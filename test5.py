...
class Bookstore(object):
    ...
    def get_book(self, book):
        if book.get_title() in self.book_list_title():
            return self.book_list.get()
...
def bookstore_update():
    bookstore_file_name = "Bookstore.json"
    with open(bookstore_file_name, encoding="utf-8") as json_file:
